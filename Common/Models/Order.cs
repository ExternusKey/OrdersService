...
public class Order
{
    ...
    [Column("order_status")] public string Status { get; set; }

    [Column("order_rejected_reason")] public string? RejectedReason { get; set; }

    [Column("order_created_date")] public DateTime OrderDate { get; set; }
}